...
class CategoryTest extends KernelTestCase
{
    ...
    {
        yield [
            '<ul><li><a href="/video_list/category/computers,6">Computers</a><ul><li><a href="/video_list/category/laptops,8">Laptops</a><ul><li><a href="/video_list/category/hp,14">HP</a></li></ul></li></ul></li></ul>',
            [
    ...
    public function testCategoryTreeAdminList($string, $array)
    {
        ...
        $categoryList = $this->mockedCategoryTreeAdminList->getCategoryList($array);
        $this->assertSame($string, $categoryList);
    }
